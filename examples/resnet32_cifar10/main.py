...
def main():
    ...
    model_info['l20_conv1'] = {'arg': 'ch_l20conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2']}
    model_info['l20_bn1']   = {'arg': 'ch_l20conv1'}
    model_info['l20_conv2'] = {'arg': 'ch_l20conv2'}
    model_info['l20_bn2']   = {'arg': 'ch_l20conv2'}

    model_info['l21_conv1'] = {'arg': 'ch_l21conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2', 'l20_bn2']}
    model_info['l21_bn1']   = {'arg': 'ch_l21conv1'}
    model_info['l21_conv2'] = {'arg': 'ch_l21conv2'}
    model_info['l21_bn2']   = {'arg': 'ch_l21conv2'}

    model_info['l22_conv1'] = {'arg': 'ch_l22conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2']}
    model_info['l22_bn1']   = {'arg': 'ch_l22conv1'}
    model_info['l22_conv2'] = {'arg': 'ch_l22conv2'}
    model_info['l22_bn2']   = {'arg': 'ch_l22conv2'}

    model_info['l23_conv1'] = {'arg': 'ch_l23conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2', 'l22_bn2']}
    model_info['l23_bn1']   = {'arg': 'ch_l23conv1'}
    model_info['l23_conv2'] = {'arg': 'ch_l23conv2'}
    model_info['l23_bn2']   = {'arg': 'ch_l23conv2'}

    model_info['l24_conv1'] = {'arg': 'ch_l24conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2', 'l22_bn2', 'l23_bn2']}
    model_info['l24_bn1']   = {'arg': 'ch_l24conv1'}
    model_info['l24_conv2'] = {'arg': 'ch_l24conv2'}
    model_info['l24_bn2']   = {'arg': 'ch_l24conv2'}


    model_info['l30_conv1'] = {'arg': 'ch_l30conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2', 'l22_bn2', 'l23_bn2', 'l24_bn2']}
    model_info['l30_bn1']   = {'arg': 'ch_l30conv1'}
    model_info['l30_conv2'] = {'arg': 'ch_l30conv2'}
    model_info['l30_bn2']   = {'arg': 'ch_l30conv2'}

    model_info['l31_conv1'] = {'arg': 'ch_l31conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2', 'l22_bn2', 'l23_bn2', 'l24_bn2', 'l30_bn2']}
    model_info['l31_bn1']   = {'arg': 'ch_l31conv1'}
    model_info['l31_conv2'] = {'arg': 'ch_l31conv2'}
    model_info['l31_bn2']   = {'arg': 'ch_l31conv2'}

    model_info['l32_conv1'] = {'arg': 'ch_l32conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2', 'l22_bn2', 'l23_bn2', 'l24_bn2','l30_bn2', 'l31_bn2']}
    model_info['l32_bn1']   = {'arg': 'ch_l32conv1'}
    model_info['l32_conv2'] = {'arg': 'ch_l32conv2'}
    model_info['l32_bn2']   = {'arg': 'ch_l32conv2'}

    model_info['l33_conv1'] = {'arg': 'ch_l33conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2', 'l22_bn2', 'l23_bn2', 'l24_bn2','l30_bn2', 'l31_bn2', 'l32_bn2']}
    model_info['l33_bn1']   = {'arg': 'ch_l33conv1'}
    model_info['l33_conv2'] = {'arg': 'ch_l33conv2'}
    model_info['l33_bn2']   = {'arg': 'ch_l33conv2'}

    model_info['l34_conv1'] = {'arg': 'ch_l34conv1', 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2', 'l22_bn2', 'l23_bn2', 'l24_bn2','l30_bn2', 'l31_bn2', 'l32_bn2', 'l33_bn2']}
    model_info['l34_bn1']   = {'arg': 'ch_l34conv1'}
    model_info['l34_conv2'] = {'arg': 'ch_l34conv2'}
    model_info['l34_bn2']   = {'arg': 'ch_l34conv2'}

    model_info['linear'] = {'arg': None, 'prev': ['bn1', 'l10_bn2', 'l11_bn2', 'l12_bn2', 'l13_bn2', 'l14_bn2','l20_bn2', 'l21_bn2', 'l22_bn2', 'l23_bn2', 'l24_bn2','l30_bn2', 'l31_bn2', 'l32_bn2', 'l33_bn2', 'l34_bn2']}
    ...
    weights, Afinal, n_args_channels = auto_prune(ResNet32, model_info, weights, Ab,
