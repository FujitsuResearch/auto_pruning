...
# for auto pruning
parser.add_argument('--acc_control', type=float, default=0.3,
...
parser.add_argument('--pretrained_model_path', type=str, default='./resnet34-5c106cde.pth',
                    help='pre-trained model filepath')
parser.add_argument('--pruned_model_path', type=str, default='./pruned_imagenet_resnet34.pt',
...
model_info['layer1.1.conv1'] = {'arg': 'ch_l11_1', 'prev': ['bn1', 'layer1.0.bn2']}
model_info['layer1.1.bn1']   = {'arg': 'ch_l11_1'}
model_info['layer1.1.conv2'] = {'arg': 'ch_l11_2'}
model_info['layer1.1.bn2']   = {'arg': 'ch_l11_2'}

model_info['layer1.2.conv1'] = {'arg': 'ch_l12_1', 'prev': ['bn1', 'layer1.0.bn2', 'layer1.1.bn2']}
model_info['layer1.2.bn1']   = {'arg': 'ch_l12_1'}
model_info['layer1.2.conv2'] = {'arg': 'ch_l12_2'}
model_info['layer1.2.bn2']   = {'arg': 'ch_l12_2'}


model_info['layer2.0.conv1'] = {'arg': 'ch_l20_1', 'prev': ['bn1', 'layer1.0.bn2', 'layer1.1.bn2', 'layer1.2.bn2']}
model_info['layer2.0.bn1']   = {'arg': 'ch_l20_1'}
model_info['layer2.0.conv2'] = {'arg': 'ch_l20_2'}
model_info['layer2.0.bn2']   = {'arg': 'ch_l20_2'}
model_info['layer2.0.downsample.0'] = {'arg': 'ch_l20_ds', 'prev': ['bn1', 'layer1.0.bn2', 'layer1.1.bn2', 'layer1.2.bn2']}
model_info['layer2.0.downsample.1'] = {'arg': 'ch_l20_ds'}

model_info['layer2.1.conv1'] = {'arg': 'ch_l21_1', 'prev': ['layer2.0.bn2', 'layer2.0.downsample.1']}
model_info['layer2.1.bn1']   = {'arg': 'ch_l21_1'}
model_info['layer2.1.conv2'] = {'arg': 'ch_l21_2'}
model_info['layer2.1.bn2']   = {'arg': 'ch_l21_2'}

model_info['layer2.2.conv1'] = {'arg': 'ch_l22_1', 'prev': ['layer2.0.bn2', 'layer2.0.downsample.1', 'layer2.1.bn2']}
model_info['layer2.2.bn1']   = {'arg': 'ch_l22_1'}
model_info['layer2.2.conv2'] = {'arg': 'ch_l22_2'}
model_info['layer2.2.bn2']   = {'arg': 'ch_l22_2'}

model_info['layer2.3.conv1'] = {'arg': 'ch_l23_1', 'prev': ['layer2.0.bn2', 'layer2.0.downsample.1', 'layer2.1.bn2', 'layer2.2.bn2']}
model_info['layer2.3.bn1']   = {'arg': 'ch_l23_1'}
model_info['layer2.3.conv2'] = {'arg': 'ch_l23_2'}
model_info['layer2.3.bn2']   = {'arg': 'ch_l23_2'}


model_info['layer3.0.conv1'] = {'arg': 'ch_l30_1', 'prev': ['layer2.0.bn2', 'layer2.0.downsample.1', 'layer2.1.bn2', 'layer2.2.bn2', 'layer2.3.bn2']}
model_info['layer3.0.bn1']   = {'arg': 'ch_l30_1'}
model_info['layer3.0.conv2'] = {'arg': 'ch_l30_2'}
model_info['layer3.0.bn2']   = {'arg': 'ch_l30_2'}
model_info['layer3.0.downsample.0'] = {'arg': 'ch_l30_ds', 'prev': ['layer2.0.bn2', 'layer2.0.downsample.1', 'layer2.1.bn2', 'layer2.2.bn2', 'layer2.3.bn2']}
model_info['layer3.0.downsample.1'] = {'arg': 'ch_l30_ds'}

model_info['layer3.1.conv1'] = {'arg': 'ch_l31_1', 'prev': ['layer3.0.bn2', 'layer3.0.downsample.1']}
model_info['layer3.1.bn1']   = {'arg': 'ch_l31_1'}
model_info['layer3.1.conv2'] = {'arg': 'ch_l31_2'}
model_info['layer3.1.bn2']   = {'arg': 'ch_l31_2'}

model_info['layer3.2.conv1'] = {'arg': 'ch_l32_1', 'prev': ['layer3.0.bn2', 'layer3.0.downsample.1', 'layer3.1.bn2']}
model_info['layer3.2.bn1']   = {'arg': 'ch_l32_1'}
model_info['layer3.2.conv2'] = {'arg': 'ch_l32_2'}
model_info['layer3.2.bn2']   = {'arg': 'ch_l32_2'}

model_info['layer3.3.conv1'] = {'arg': 'ch_l33_1', 'prev': ['layer3.0.bn2', 'layer3.0.downsample.1', 'layer3.1.bn2', 'layer3.2.bn2']}
model_info['layer3.3.bn1']   = {'arg': 'ch_l33_1'}
model_info['layer3.3.conv2'] = {'arg': 'ch_l33_2'}
model_info['layer3.3.bn2']   = {'arg': 'ch_l33_2'}

model_info['layer3.4.conv1'] = {'arg': 'ch_l34_1', 'prev': ['layer3.0.bn2', 'layer3.0.downsample.1', 'layer3.1.bn2', 'layer3.2.bn2', 'layer3.3.bn2']}
model_info['layer3.4.bn1']   = {'arg': 'ch_l34_1'}
model_info['layer3.4.conv2'] = {'arg': 'ch_l34_2'}
model_info['layer3.4.bn2']   = {'arg': 'ch_l34_2'}

model_info['layer3.5.conv1'] = {'arg': 'ch_l35_1', 'prev': ['layer3.0.bn2', 'layer3.0.downsample.1', 'layer3.1.bn2', 'layer3.2.bn2', 'layer3.3.bn2', 'layer3.4.bn2']}
model_info['layer3.5.bn1']   = {'arg': 'ch_l35_1'}
model_info['layer3.5.conv2'] = {'arg': 'ch_l35_2'}
model_info['layer3.5.bn2']   = {'arg': 'ch_l35_2'}


model_info['layer4.0.conv1'] = {'arg': 'ch_l40_1', 'prev': ['layer3.0.bn2', 'layer3.0.downsample.1', 'layer3.1.bn2', 'layer3.2.bn2', 'layer3.3.bn2', 'layer3.4.bn2', 'layer3.5.bn2']}
model_info['layer4.0.bn1']   = {'arg': 'ch_l40_1'}
model_info['layer4.0.conv2'] = {'arg': 'ch_l40_2'}
model_info['layer4.0.bn2']   = {'arg': 'ch_l40_2'}
model_info['layer4.0.downsample.0'] = {'arg': 'ch_l40_ds', 'prev': ['layer3.0.bn2', 'layer3.0.downsample.1', 'layer3.1.bn2', 'layer3.2.bn2', 'layer3.3.bn2', 'layer3.4.bn2', 'layer3.5.bn2']}
model_info['layer4.0.downsample.1'] = {'arg': 'ch_l40_ds'}

model_info['layer4.1.conv1'] = {'arg': 'ch_l41_1', 'prev': ['layer4.0.bn2', 'layer4.0.downsample.1']}
model_info['layer4.1.bn1']   = {'arg': 'ch_l41_1'}
model_info['layer4.1.conv2'] = {'arg': 'ch_l41_2'}
model_info['layer4.1.bn2']   = {'arg': 'ch_l41_2'}

model_info['layer4.2.conv1'] = {'arg': 'ch_l42_1', 'prev': ['layer4.0.bn2', 'layer4.0.downsample.1', 'layer4.1.bn2']}
model_info['layer4.2.bn1']   = {'arg': 'ch_l42_1'}
model_info['layer4.2.conv2'] = {'arg': 'ch_l42_2'}
model_info['layer4.2.bn2']   = {'arg': 'ch_l42_2'}

model_info['fc'] = {'arg': None, 'prev': ['layer4.0.bn2', 'layer4.0.downsample.1', 'layer4.1.bn2', 'layer4.2.bn2']}
#===================================================================================
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    weights, Afinal, n_args_channels = auto_prune(ResNet34, model_info, weights, Ab,
